        ...
        <header className="bg-blue-900 text-white shadow-md border-b border-blue-800 sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            <nav className="flex items-center gap-1">
              <Link
                href="/"
                className="px-4 py-2 rounded-lg text-sm font-semibold text-blue-100 hover:text-white hover:bg-blue-800/80 transition-all"
              >
                Dashboard
              </Link>
              <Link
                href="/application"
                className="px-4 py-2 rounded-lg text-sm font-semibold text-blue-100 hover:text-white hover:bg-blue-800/80 transition-all flex items-center gap-1.5"
              >
